...
- Model Based Architecture Synthesis (MBAS)
  ...
  - Synthesis of a minimal set of defenses that mitigate the cyber requirements using existing implemented defenses in two modes: mitigated (existing implemented defenses mitigate the cyber requirements) and unmitigated (otherwise)
