(* filename: /Users/a212461047/git/materials/MBAS/tool/examples/modelUnderTest/MBAS-Files/ReadIn/ModelA-1_1-ApplicableDefense.ml *)
...
let library = [
	...
	{ name             = "GPS"; 
	  ...
	  defense_events   = [ "SC-29"; "SC-40"; ]; 
	  defense_rigors   = [ 7; 7; ]; 
	  defense_profiles = [
		( "CAPEC-148", And[ D[ "SC-29"; ]; ]); 
		( "CAPEC-601", Or[ D[ "SC-40"; ]; ]);  ]; 
	}; 
	{ name             = "MissionPlanner"; 
	  input_flows      = [ ]; 
	  output_flows     = [ "tasks"; ]; 
	...
	{ name             = "RCReceiver"; 
	  ...
	  defense_events   = [ "IA-2"; "IA-3"; "IA-7"; "SC-10"; "SC-12"; "SC-13"; "SC-23"; "SC-40"; "SC-5"; "SC-6"; "SC-7"; "SC-8"; "SI-10"; "SI-17"; ]; 
	  defense_rigors   = [ 7; 7; 7; 7; 7; 7; 7; 7; 7; 7; 7; 7; 7; 7; ]; 
	  defense_profiles = [
		( "CAPEC-125", Or[ D[ "SC-5"; ]; D[ "SC-6"; ]; D[ "SC-7"; ]; ]); 
		( "CAPEC-148", And[ D[ "IA-2"; ]; D[ "IA-3"; ]; D[ "IA-7"; ]; D[ "SC-10"; ]; D[ "SC-12"; ]; D[ "SC-13"; ]; D[ "SC-23"; ]; D[ "SC-8"; ]; ]); 
		( "CAPEC-151", And[ D[ "IA-2"; ]; D[ "IA-3"; ]; D[ "IA-7"; ]; D[ "SC-10"; ]; D[ "SC-12"; ]; D[ "SC-13"; ]; D[ "SC-23"; ]; D[ "SC-8"; ]; ]); 
		( "CAPEC-28", And[ D[ "SI-10"; ]; D[ "SI-17"; ]; ]); 
		( "CAPEC-601", Or[ D[ "SC-40"; ]; ]);  ]; 
	}; 
