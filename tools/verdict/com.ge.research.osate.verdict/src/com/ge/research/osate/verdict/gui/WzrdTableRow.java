...
public class WzrdTableRow implements Serializable, Cloneable {
    ...
    private Integer
            firstElement; // contains the index corresponding to the first drop-down cell in StatementEditor window
    private Integer
            secondElement; // contains the index corresponding to the second drop-down cell in StatementEditor window
    ...
    private boolean newRow =
            true; // boolean information regarding whether the row corresponds to an existing content in .aadl or added
    // newly
    ...
    private String
            verdictStatement; // contains the verdict statement generated by Wizard before writing into the .aadl file
    private String comment =
            null; // contains the comment field of (existing) cyber property (Note: Wizard doesn't provide feature to
    // edit this fields)
    private String description =
            null; // contains the description field of (existing) cyber property (Note: Wizard doesn't provide feature
    // to edit this fields)
    private String phase =
            null; // contains the phase field of (existing) cyber property (Note: Wizard doesn't provide feature to edit
    // this fields)
    private String external =
            null; // contains the external field of (existing) cyber property (Note: Wizard doesn't provide feature to
    // edit this fields)
