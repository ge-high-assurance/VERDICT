...
public class MissionEditor extends ApplicationWindow {
	...
	public MissionEditor(Shell shell, Rectangle sourceRect, List<WzrdTableRow> tableContents,
			List<MissionInfo> missions, DrpDnLists drpdn, Set<String> idSet) {
		super(shell);
		lastShell = shell;
	...
	public MissionEditor(Shell shell, Shell generatingShell, Rectangle sourceRect, List<WzrdTableRow> tableContents,
			List<MissionInfo> missions, DrpDnLists drpdn) {
		super(shell);
		...
		add.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				...
				if (addIsValid) {
					...
					MissionEditor ldEditor = new MissionEditor(lastShell, sourceRect, tableContents,
	...
	private void createMissionComposite(MissionInfo mission, int ii) {
		...
		delete.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				...
				MissionEditor ldEditor = new MissionEditor(lastShell, sourceRect, tableContents, missions, drpdn,
						idSet);
				ldEditor.run();
			}
		});
