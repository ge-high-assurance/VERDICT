...
public class CRVHandler extends AbstractHandler {
            ...
            Thread crvAnalysisThread = new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        String outputPath =
                                new File(System.getProperty("java.io.tmpdir"), "crv_output.xml").getCanonicalPath();
                        String outputPathBa =
                                new File(System.getProperty("java.io.tmpdir"), "crv_output_ba.xml").getCanonicalPath();
    ...
    public static boolean runBundle(
            String bundleJar, String dockerImage, File vdmFile, String outputPath, String kind2bin) throws IOException {
