...
public class MBASSafetyResult {
	...
	public MBASSafetyResult(String reqName, String defenseType, String computedLikelihood, String acceptableLikelihood,
		...
		try {
			...
			System.out.println(
					"Error parsing probablities: " + getAcceptableLikelihood() + ", " + getComputedLikelihood());
			successful = false;
		}
	}
