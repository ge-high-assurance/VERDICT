...
public class DrpDnLists {
    ...
    public final String[] CIA_WITH_NULL = {"", "Confidentiality (C)", "Integrity (I)", "Availability (A)"};
    ...
    public final String[] SEVERITY = {"Catastrophic", "Hazardous", "Major", "Minor", "No safety effect"};
    public String[] inPorts;
    public String[] outPorts;
    public String[] inPortsWithNull;
    public String[] outPortsWithNull;
    public String inStr; // this stores the "Available INPorts" to display in top of StatementEditor window
    public String outStr; // this stores the "Available OUTPorts" to display in top of StatementEditor window
