    ...
    public void createPartControl(Composite parent) {
...

        {
            ...
            if (results.partialSolution) {
                if (results.inputSat) {
                    ...
                    if (results.meritAssignment) {
                        if (!results.inputCost.equals(results.outputCost)) {
                            header.setText("Synthesis results: Existing solution SAT, merit assignment, cost: "
                        ...
                        header.setText("Synthesis results: Existing solution SAT, no merit assignment, total cost: "
                                + results.outputCost.doubleValue());
                    }
                } else {
                ...
                header.setText("Synthesis results (not using existing solution): total cost: "
                        + results.outputCost.doubleValue());
            }
        }
