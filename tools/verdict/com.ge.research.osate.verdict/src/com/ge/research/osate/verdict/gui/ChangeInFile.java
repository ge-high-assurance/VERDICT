...
public class ChangeInFile {
    ...
    protected void refreshFile(int offset, boolean needToAppend, String appendix, Boolean systemLevel)
        ...
        FileReader file = new FileReader(ResourcesPlugin.getWorkspace()
                ...
                .toURL()
                .getPath());
        String wrtpath = ResourcesPlugin.getWorkspace()
                .getRoot()
        ...
        file.close();
        tmpFile.close();
        String newpath = ResourcesPlugin.getWorkspace()
                .getRoot()
                .getFile(modelPath)
                .getRawLocationURI()
                .toURL()
                        ...
                        if (!missionTags.get(i)) {
                            offsets.set(
                                    ...
                                    offsets.get(i)
                                            - 9
                                            - spaceCount
                                            - tabCount); // constant 9 is for keyword "CyberReq"/"CyberRel" and a \n
                            lengths.set(
                                    i,
                                    lengths.get(i)
                                            + 9
                            ...
                            offsets.set(
                                    ...
                                    offsets.get(i)
                                            - 11
                                            - spaceCount
                                            - tabCount); // constant 11 is for keyword "MissionReq" and a \n
                            lengths.set(
                                    i,
                                    lengths.get(i)
                                            + 11
