...
public class WzrdDashboard extends ApplicationWindow {
                            ...
                            for (int j = 0; j < systems.size(); j++) {
                                if (systems.get(j).getFullName().equals(aButton.getText())) {
                                    ...
                                    try {
                                        ...
                                        // from the current (possibly modified)
                                        // resource
                                    } catch (Exception e) {
                                        e.printStackTrace();
                                    }
                                        ...
                                        if (checkIfSystem(systems.get(j))) {
                                            aButton.setBackground(
                                                    new Color(
                                                            ...
                                                            145,
                                                            169,
                                                            216)); // system with a corresponding
                                            // .impl in invoking
                                            // .aadl
                                        } else {
                                            switch (colorTag) {
    ...
    // check if component corr. to selected button is "top-level" (i.e. invoking .aadl contains a
    // corresponding .impl element)
