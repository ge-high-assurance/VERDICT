...
public class CRVResultsView extends ViewPart {
    ...
    private Image getIcon(String name) {
        return ResourceLocator.imageDescriptorFromBundle("com.ge.research.osate.verdict", "icons/" + name)
                .get()
                .createImage();
    }
    ...
    public void createPartControl(Composite parent) {
        ...
        boolean showBlameAssignmentInfo =
                CRVSettingsPanel.isBlameAssignment && tableContents.stream().anyMatch(CRVSummaryRow::hasCounterExample);
        ;
        ...
        table.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                boolean invalidProperty = !tableContents
                                    ...
                                    CRVReportGenerator.window
                                            ...
                                            .asyncExec(() -> {
                                                try {
                                                    CRVReportGenerator.window
                                                            .getActivePage()
                                                            .showView(MeritAssignmentView.ID);
