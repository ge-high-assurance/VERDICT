...
public class CapecDefenseTable {
	...
	public CapecDefenseTable(Display display, Shell lastShell, List<PathAttributes> list, Map<String, String> attackDesc, Map<String, String> defenseDesc) {
		pathList = list;
		tableContents = loadTableContents(pathList, attackDesc, defenseDesc);
	}

	private List<CapecDefenseRow> loadTableContents(List<PathAttributes> list, Map<String, String> attackDesc, Map<String, String> defenseDesc) {
