        ...
        try {
            ...
            for (int temp = 0; temp < nList.getLength(); temp++) {
                ...
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    newProperty.setSource(eElement.getElementsByTagName("Answer")
                            .item(0)
                            .getAttributes()
                            .getNamedItem("source")
                            .getTextContent());
                    ...
                    if (eElement.getElementsByTagName("Answer")
                            ...
                            .getTextContent()
                            .equals("falsifiable")) {
                        newProperty.setCntExample(extractCE(
                                eElement.getElementsByTagName("CounterExample").item(0)));
                        newProperty.setBlameAssignment(
                            ...
                            .equals("unknown")) {
                        try {
                            newProperty.setValidTill(eElement.getElementsByTagName("TrueFor")
                                    .item(0)
                                    .getTextContent());
                        } catch (Exception e) {
                            // do nothing
        ...
        if (eElement != null) {
            ...
            if (nMinA != null) {
                ...
                for (int i = 0; i < componentList.getLength(); i++) {
                    ...
                    String componentName = nComponent
                            .getAttributes()
                            .getNamedItem("ComponentID")
                            .getTextContent();
                    if ("true"
                            .equals(nComponent
                                    .getAttributes()
                ...
                for (int i = 0; i < linkList.getLength(); i++) {
                    ...
                    String linkName =
                            nLink.getAttributes().getNamedItem("LinkID").getTextContent();
                    if ("true"
                            .equals(nLink.getAttributes()
                                    .getNamedItem("Compromised")
                                    .getTextContent())) {
