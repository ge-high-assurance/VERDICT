...
public class BundlePreferences extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void createFieldEditors() {
        ...
        LabelFieldEditor separator = new LabelFieldEditor(
                "   --- Remaining fields not needed if Docker is used ---   ", getFieldEditorParent());
        addField(separator);
        ...
        FileFieldEditor soteriaPpBin =
                new FileFieldEditor(SOTERIA_PP_BIN, "Soteria++ Binary:", true, getFieldEditorParent());
