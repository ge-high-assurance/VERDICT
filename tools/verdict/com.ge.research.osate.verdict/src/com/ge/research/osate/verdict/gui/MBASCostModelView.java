...
public class MBASCostModelView extends ApplicationWindow {
    ...
    public void createThreeColumnTableCatByCompAndConn(Composite leftColumn, boolean isProp, int height, int width) {
        final Table table =
                new Table(leftColumn, SWT.BORDER | SWT.MULTI | SWT.FULL_SELECTION | SWT.RESIZE | SWT.V_SCROLL);
    ...
    protected Control createContents(Composite parent) {
        ...
        newRule.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                costModel.rules.add(costModel.createRule(
        ...
        entityCol.setEditingSupport(new EditingSupport(tableViewer) {
            ...
            protected Object getValue(Object element) {
                ...
                if (rule.component.isPresent()) {
                    Integer index =
                            suggComponentsIndexMap.get(rule.parent.get()).get(rule.getComponentStr());
            ...
            protected void setValue(Object element, Object value) {
                ...
                costModel.updateRule(
                        ...
                        rule.updateComponent(
                                suggComponents.get(rule.parent.get()).get((Integer) value)));
            }
        });
            ...
            public void modify(Object element, String property, Object value) {
                ...
                if (element instanceof SynthesisCostModel.Rule) {
                    ...
                    switch (property) {
                        ...
                        case "defenseProp":
                            costModel.updateRule(
                                    rule, rule.updateDefenseProperty(suggDefenseProps.get((Integer) value)));
                            break;
                        case "dal":
