...
public class VerdictTemplateContext extends XtextTemplateContext {
	public VerdictTemplateContext(TemplateContextType type, IDocument document, Position position,
	...
	public VerdictTemplateContext(TemplateContext context) {
		super(context.getContextType(), ((DocumentTemplateContext) context).getDocument(),
