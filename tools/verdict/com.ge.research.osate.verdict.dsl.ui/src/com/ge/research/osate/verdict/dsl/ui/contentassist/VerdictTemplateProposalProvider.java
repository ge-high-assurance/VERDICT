...
public class VerdictTemplateProposalProvider extends DefaultTemplateProposalProvider {
	...
	@Inject
	public VerdictTemplateProposalProvider(TemplateStore templateStore, ContextTypeRegistry registry,
	...
	protected TemplateProposal doCreateProposal(Template template, TemplateContext templateContext,
		...
		return new XtextTemplateProposal(template, new VerdictTemplateContext(templateContext),
				context.getReplaceRegion(), image, relevance);
	}
}
